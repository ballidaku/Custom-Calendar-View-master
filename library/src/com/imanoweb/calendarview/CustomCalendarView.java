...
public class CustomCalendarView extends LinearLayout
{
    ...
    private View view;
    private ImageView previousYearButton;
    ...
    private int calendarBackgroundColorSharan;
    ...
    private void getAttributes(AttributeSet attrs)
    {
        ...
        calendarBackgroundColorSharan = typedArray.getColor(R.styleable.CustomCalendarView_calendarBackgroundColor, getResources().getColor(R.color.black));
    ...
    private void initializeCalendar()
    {
        ...
        previousYearButton = (ImageView) view.findViewById(R.id.leftButtonYear);
        nextYearButton = (ImageView) view.findViewById(R.id.rightButtonYear);
        ...
        previousYearButton.setOnClickListener(new OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
                ...
                {
                    calendarListener.onYearChanged(currentCalendar.getTime());
                }
            }
        });
    ...
    private void initializeTitleLayout()
    {
        ...
        String monthText = new DateFormatSymbols(locale).getShortMonths()[currentCalendar.get(Calendar.MONTH)].toString();
        monthText = monthText.substring(0, 1).toUpperCase() + monthText.subSequence(1, monthText.length());

        TextView monthTitle = (TextView) view.findViewById(R.id.monthTitle);
        TextView yearTitle = (TextView) view.findViewById(R.id.yearTitle);

        monthTitle.setTextColor(calendarTitleTextColor);
        yearTitle.setTextColor(calendarTitleTextColor);

        monthTitle.setText(monthText);
        yearTitle.setText(""+currentCalendar.get(Calendar.YEAR));
        ...
        {
            monthTitle.setTypeface(getCustomTypeface(), Typeface.BOLD);
            yearTitle.setTypeface(getCustomTypeface(), Typeface.BOLD);
        }
...
//            Log.e("dayOfTheWeekString",dayOfTheWeekString);
    ...
    public boolean isSameMonth(Calendar c1, Calendar c2)
    {
        ...
        return (c1.get(Calendar.ERA) == c2.get(Calendar.ERA) && c1.get(Calendar.YEAR) == c2.get(Calendar.YEAR) && c1.get(Calendar.MONTH) == c2.get(Calendar.MONTH));
    }
...
//            dayOfMonth.setTextColor(currentDayOfMonth);
            dayOfMonth.setTextColor(Color.parseColor("#FFC77731"));
//            dayOfMonth.setBackgroundResource(R.drawable.round_background);
        }
    }
    ...
    public void markDayAsSelectedDay(Date currentDate)
    {
     ...
     //   storeLastValues(currentDate);
        ...
        else
       {
           ...
           Log.e("selectedDates",""+selectedDates);
